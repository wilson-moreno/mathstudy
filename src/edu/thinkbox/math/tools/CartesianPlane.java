...
public class CartesianPlane extends Group{
      ...
      private static final double ARROW_SIZE = 140;
      private int   width;
      private int   height;
      ...
      private Group createAxes(){
        ...
        arrow1.setEntry( 1, 0, ( ( height - 5 ) / moduleSize ) / 2 );
        arrow2.setEntry( 0, 0, 0.0 );
        arrow2.setEntry( 1, 0,  -1 * ( ( ( height - 5 ) / moduleSize ) / 2 ) );
        arrow3.setEntry( 0, 0, ( ( width - 5 ) / moduleSize ) / 2  );
        arrow3.setEntry( 1, 0, 0.0 );
        arrow4.setEntry( 0, 0, -1 * ( ( ( width - 5 ) / moduleSize ) / 2 ) );
